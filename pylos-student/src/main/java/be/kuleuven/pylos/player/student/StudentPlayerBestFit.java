...
public class StudentPlayerBestFit extends PylosPlayer{
    ...
    public void doMove(PylosGameIF game, PylosBoard board) {
        ...
        Movement bestMove = emptyMovement.simulate(new PylosGameSimulator(game.getState(), this.PLAYER_COLOR, board), board, 0, true, new HashMap<>());
    ...
    public void doRemove(PylosGameIF game, PylosBoard board) {
        ...
        Movement bestRemoveFirst = emptyMovement.simulate(new PylosGameSimulator(game.getState(), this.PLAYER_COLOR, board), board, 0, true, new HashMap<>());
    ...
    public void doRemoveOrPass(PylosGameIF game, PylosBoard board) {
        ...
        Movement bestRemoveSecond = emptyMovement.simulate(new PylosGameSimulator(game.getState(), this.PLAYER_COLOR, board), board, 0, true, new HashMap<>());
